...
\begin{document}
	...
	\begin{center}
		\includegraphics[width=14cm]{Fig. 1 Boarding process of a specific passenger.jpg}
	...
	\begin{center}
		\includegraphics[width = 14cm]{Fig. 2 Construction of cells.jpg}
	...
	\begin{center}
	\includegraphics[width = 11cm]{Fig. 3 The effective factor.jpg}
	...
	\begin{itemize}
		...
		\begin{center}
		\includegraphics[width = 10cm]{Fig. 4 Offering a seat.jpg}
	...
	\begin{center}
		\includegraphics[height = 5cm]{Fig. 5 Discrete optimization.jpg}
	...
	\begin{center}
		\includegraphics[height = 4cm]{Fig. 6 Two ideal boarding plans 1.jpg}
		\includegraphics[height = 4cm]{Fig. 6 Two ideal boarding plans 2.jpg}
	...
	\begin{center}
		\includegraphics[width = 14cm]{Fig. 7 Visualization of the actions.jpg}
	...
	\begin{center}
		\includegraphics[width=15cm]{Fig. 8 best disembarking strategy.jpg}
	...
	\begin{center}
		\includegraphics[width = 17cm]{Fig. 9 alpha\_satisfy in random boarding.png}
	...
	\begin{center}
		\includegraphics[height=3.7cm]{Fig. 10-13 Left to Right 1.jpg}
		\includegraphics[height=3.7cm]{Fig. 10-13 Left to Right 2.jpg}
		\includegraphics[height=3.7cm]{Fig. 10-13 Left to Right 3.jpg}
		\includegraphics[height=3.7cm]{Fig. 10-13 Left to Right 4.jpg}
	...
	\begin{itemize}
		...
		\begin{center}
			\includegraphics[height = 4.5cm]{Fig. 14-16 1.jpg}
			\includegraphics[height = 4.5cm]{Fig. 14-16 2.jpg}
			\includegraphics[height = 4.5cm]{Fig. 14-16 3.jpg}
	...
	\begin{center}
		\includegraphics[width = 14cm]{Fig. 17 Time step comparison on different types of boarding strategies.jpg}
	...
	\begin{center}
		\includegraphics[height = 5.5cm]{Fig. 18 Generated random sigmoid non-compliance factor.png}
	...
	\begin{center}
		\includegraphics[height = 5cm]{Fig. 19-21 Plot of time steps to A\_x 1.jpg}
		\includegraphics[height = 5cm]{Fig. 19-21 Plot of time steps to A\_x 2.jpg}
		\includegraphics[height = 5cm]{Fig. 19-21 Plot of time steps to A\_x 3.jpg}
	...
	\begin{center}
		\includegraphics[height = 5cm]{Fig. 22-24 Plot of time steps to s_x 1.jpg}
		\includegraphics[height = 5cm]{Fig. 22-24 Plot of time steps to s_x 2.jpg}
		\includegraphics[height = 5cm]{Fig. 22-24 Plot of time steps to s_x 3.jpg}
	...
	\begin{center}
		\includegraphics[height = 5cm]{Fig. 25-26 Queue-jumping analysis 1.jpg}
		\includegraphics[height = 5cm]{Fig. 25-26 Queue-jumping analysis 2.jpg}
	...
	\begin{center}
		\includegraphics[height = 4cm]{Fig. 27-29 Reduction of passengers 1.jpg}
		\includegraphics[height = 4cm]{Fig. 27-29 Reduction of passengers 2.jpg}
		\includegraphics[height = 4cm]{Fig. 27-29 Reduction of passengers 3.jpg}
	...
	\begin{center}
		\includegraphics[width=12cm]{Fig. 30 Flying Wings.jpg}
	...
	\begin{center}
		\includegraphics[width = 10cm]{Fig. 31 coordinate system for the Flying Wing.jpg}
	...
	\begin{center}
		\includegraphics[height = 4cm]{Fig. 32 Ideal scheme for the Flying Wing.jpg}
	...
	\begin{center}
		\includegraphics[width = 14cm]{Fig. 33 Optimization result.jpg}
	...
	\begin{center}
		\includegraphics[width=14cm]{Fig. 34 Division of two entrance, two aisle plane.jpg}
	...
	\begin{center}
		\includegraphics[height = 5cm]{Fig. 35 First-half passenger influx.jpg}
	...
	\begin{itemize}
		...
		\begin{center}
			\includegraphics[width=12cm]{advice.jpg}
		\end{center}
	\end{itemize}
